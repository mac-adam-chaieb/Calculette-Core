...
public enum UnaryOperator 
{
	...
	LEN("len"), LOG("log"), LN("ln"), COSINE("cos"), SINE("sin"), TANGENT("tan"), FACTORIAL("!"), SQROOT1("sqrt"), SQROOT2("\u221A"), NEGATE("-"), IDENTITY("+"), ARCCOS("arccos"), ARCSIN("arcsin"), ARCTAN("arctan"), ABSOLUTE("abs");
